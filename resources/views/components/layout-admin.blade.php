...
<body>
  <div class="container-scroller"> 
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="/dashboard/visit">
  ...
  <script src="{{ asset("template_admin/template/vendors/js/vendor.bundle.base.js") }}"></script>
  {{-- <script src="vendors/js/vendor.bundle.base.js"></script> --}}
  <!-- endinject -->
  <!-- Plugin js for this page -->
  <script src="{{ asset("template_admin/template/vendors/chart.js/Chart.min.js") }}"></script>
  <script src="{{ asset("template_admin/template/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js") }}"></script>
  <script src="{{ asset("template_admin/template/vendors/progressbar.js/progressbar.min.js") }}"></script>
{{-- 
